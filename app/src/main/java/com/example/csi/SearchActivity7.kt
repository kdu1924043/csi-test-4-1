...
class SearchActivity7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storageReference = FirebaseStorage.getInstance().reference.child("one plus.json")
    ...
    private fun loadJSONFromFirebaseStorage() {
        val localFile = createTempFile("one plus", "json")
