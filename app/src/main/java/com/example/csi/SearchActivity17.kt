...
class SearchActivity17 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storageReference = FirebaseStorage.getInstance().reference.child("water.json")
    ...
    private fun loadJSONFromFirebaseStorage() {
        val localFile = createTempFile("water", "json")
