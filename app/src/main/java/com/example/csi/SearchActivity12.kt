...
class SearchActivity12 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storageReference = FirebaseStorage.getInstance().reference.child("insnoodle.json")
    ...
    private fun loadJSONFromFirebaseStorage() {
        val localFile = createTempFile("insnoodle", "json")
