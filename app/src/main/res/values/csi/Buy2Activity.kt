...
class Buy2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.csi.R.layout.activity_buy)
    }
    fun DefaultPayment(v: View?) {
        val intent = Intent(applicationContext, values.csi.DefaultPaymentActivity::class.java)
        startActivity(intent)
    }

    fun TotalPayment(v: View?) {
        val intent = Intent(applicationContext, values.csi.TotalPaymentActivity::class.java)
        startActivity(intent)
    }
