...
class SearchActivity21 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storageReference = FirebaseStorage.getInstance().reference.child("protein.json")
    ...
    private fun loadJSONFromFirebaseStorage() {
        val localFile = createTempFile("protein", "json")
