...
class SearchActivity20 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storageReference = FirebaseStorage.getInstance().reference.child("coffee.json")
    ...
    private fun loadJSONFromFirebaseStorage() {
        val localFile = createTempFile("coffee", "json")
